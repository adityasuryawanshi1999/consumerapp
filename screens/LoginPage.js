            ...
            <View style={styles.rootContainer} >
                ...
                <View style={styles.textContainer} >
                    <Card style={{width: '98%', flex: 1, justifyContent: "center", alignContent: 'center', alignItems: 'center'}} >
                        ...
                        <Text style={{fontWeight: 'bold', fontSize: 15, textAlign: 'center'}} >Sign in with user email!</Text>
                ...
                <Text style={{color: 'black', marginTop: Dimensions.get('screen').width*0.05, textAlign: 'center'}} >Rental Portal</Text>
